...
<report name="Clinici" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="CLINICI" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL CLINICI.ID_CLINICA, CLINICI.ID_LOCATIE, CLINICI.ID_TIP_CLINICA, CLINICI.ID_DETALII_CLINICA, CLINICI.NUME, LOCATIE.ID_LOCATIE, LOCATIE.ID_JUDET, 
LOCATIE.ADRESA, JUDETE.ID_JUDET, JUDETE.NUME AS JUDET
FROM CLINICI, LOCATIE, JUDETE
WHERE ((CLINICI.ID_LOCATIE = LOCATIE.ID_LOCATIE)
 AND (LOCATIE.ID_JUDET = JUDETE.ID_JUDET)) ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_ID_CLINICA">
        <displayInfo x="1.01111" y="1.94995" width="1.97791" height="1.62695"
        />
        <dataItem name="ID_CLINICA" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Id Clinica">
          <dataDescriptor expression="CLINICI.ID_CLINICA"
           descriptiveExpression="ID_CLINICA" order="1"
           oracleDatatype="number" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NUME" datatype="vchar2" columnOrder="15" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nume">
          <dataDescriptor expression="CLINICI.NUME"
           descriptiveExpression="NUME" order="5" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ADRESA" datatype="vchar2" columnOrder="18" width="50"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Adresa">
          <dataDescriptor expression="LOCATIE.ADRESA"
           descriptiveExpression="ADRESA" order="8" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JUDET" datatype="vchar2" columnOrder="19" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nume1">
          <xmlSettings xmlTag="NUME1"/>
          <dataDescriptor expression="JUDETE.NUME"
           descriptiveExpression="JUDET" order="10" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_JUDET1" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Id Judet1">
          <dataDescriptor expression="JUDETE.ID_JUDET"
           descriptiveExpression="ID_JUDET" order="9" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_LOCATIE" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Id Locatie">
          <dataDescriptor expression="CLINICI.ID_LOCATIE"
           descriptiveExpression="ID_LOCATIE" order="2"
           oracleDatatype="number" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_TIP_CLINICA" oracleDatatype="number"
         columnOrder="13" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Id Tip Clinica">
          <dataDescriptor expression="CLINICI.ID_TIP_CLINICA"
           descriptiveExpression="ID_TIP_CLINICA" order="3"
           oracleDatatype="number" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_DETALII_CLINICA" oracleDatatype="number"
         columnOrder="14" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="Id Detalii Clinica">
          <dataDescriptor expression="CLINICI.ID_DETALII_CLINICA"
           descriptiveExpression="ID_DETALII_CLINICA" order="4"
           oracleDatatype="number" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_LOCATIE1" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Id Locatie1">
          <dataDescriptor expression="LOCATIE.ID_LOCATIE"
           descriptiveExpression="ID_LOCATIE" order="6"
           oracleDatatype="number" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ID_JUDET" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Id Judet">
          <dataDescriptor expression="LOCATIE.ID_JUDET"
           descriptiveExpression="ID_JUDET" order="7" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
  ...
  <section name="main">
    <body>
      <frame name="M_G_ID_CLINICA_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.18750" height="0.37500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"/>
        <repeatingFrame name="R_G_ID_CLINICA" source="G_ID_CLINICA"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_JUDET" source="JUDET" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
        ...
        <frame name="M_G_ID_CLINICA_HDR">
          ...
          <text name="B_JUDET" minWidowLines="1">
            <textSettings spacing="0"/>
...
<rw:dataArea id="MGIDCLINICAGRPFR40">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBIDCLINICA40" asArray="no"/> class="OraColumnHeader"> Id Clinica </th>
   <th <rw:id id="HBNUME40" asArray="no"/> class="OraColumnHeader"> Nume </th>
   <th <rw:id id="HBADRESA40" asArray="no"/> class="OraColumnHeader"> Adresa </th>
   <th <rw:id id="HBJUDET40" asArray="no"/> class="OraColumnHeader"> Judet </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGIDCLINICA401" src="G_ID_CLINICA">
   <tr>
    <td <rw:headers id="HFIDCLINICA40" src="HBIDCLINICA40"/> class="OraCellNumber"><rw:field id="FIDCLINICA40" src="ID_CLINICA" nullValue="&nbsp;"> F_ID_CLINICA </rw:field></td>
    <td <rw:headers id="HFNUME40" src="HBNUME40"/> class="OraCellText"><rw:field id="FNUME40" src="NUME" nullValue="&nbsp;"> F_NUME </rw:field></td>
    <td <rw:headers id="HFADRESA40" src="HBADRESA40"/> class="OraCellText"><rw:field id="FADRESA40" src="ADRESA" nullValue="&nbsp;"> F_ADRESA </rw:field></td>
    <td <rw:headers id="HFJUDET40" src="HBJUDET40"/> class="OraCellText"><rw:field id="FJUDET40" src="JUDET" nullValue="&nbsp;"> F_JUDET </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
