...
<report name="Judet-Tara" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL COUNTRY.COUNTRY, COUNTY.COUNTY, COUNTY.COUNTRY_ID, COUNTY.COUNTY_ID, COUNTRY.COUNTRY_ID
FROM COUNTRY, COUNTY
WHERE (COUNTY.COUNTRY_ID = COUNTRY.COUNTRY_ID) ]]>
      ...
      <group name="G_COUNTRY_ID">
        ...
        />
        <dataItem name="COUNTRY_ID" oracleDatatype="number" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Country Id">
          <dataDescriptor expression="COUNTY.COUNTRY_ID"
           descriptiveExpression="COUNTRY_ID" order="3" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="CountCOUNTYPerCOUNTRY_ID" source="COUNTY"
      ...
      <group name="G_COUNTRY">
        ...
        />
        <dataItem name="COUNTRY" datatype="vchar2" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Country">
          <dataDescriptor expression="COUNTRY.COUNTRY"
           descriptiveExpression="COUNTRY" order="1" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTY" datatype="vchar2" columnOrder="12" width="510"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="County">
          <dataDescriptor expression="COUNTY.COUNTY"
           descriptiveExpression="COUNTY" order="2" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTY_ID" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="County Id">
          <dataDescriptor expression="COUNTY.COUNTY_ID"
           descriptiveExpression="COUNTY_ID" order="4" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTRY_ID1" oracleDatatype="number" columnOrder="15"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Country Id1">
          <dataDescriptor expression="COUNTRY.COUNTRY_ID"
           descriptiveExpression="COUNTRY_ID" order="5" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountCOUNTYPerReport" source="COUNTY" function="count"
  ...
  <section name="main">
    <body>
      <frame name="M_G_COUNTRY_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.37500" height="0.93750"
        />
          ...
          <frame name="M_G_COUNTRY_GRPFR">
            ...
            <repeatingFrame name="R_G_COUNTRY" source="G_COUNTRY"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <field name="F_COUNTY_ID" source="COUNTY_ID" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="3.00000" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_COUNTRY_ID1" source="COUNTRY_ID1"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.18750" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_COUNTRY_FTR">
              <geometryInfo x="0.00000" y="0.56250" width="5.37500"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_CountCOUNTYPerCOUNTRY_ID"
               source="CountCOUNTYPerCOUNTRY_ID" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10" bold="yes"
                 textColor="TextColor"/>
            ...
            <frame name="M_G_COUNTRY_HDR">
              ...
              <text name="B_COUNTY_ID" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.00000" y="0.18750" width="1.18750"
                 height="0.18750"/>
              ...
              <text name="B_COUNTRY_ID1" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.18750" y="0.18750" width="1.18750"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
        ...
        <frame name="M_G_COUNTRY_ID_FTR">
          <geometryInfo x="0.00000" y="0.75000" width="5.37500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_CountCOUNTYPerReport" source="CountCOUNTYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="0.43750" y="0.75000" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_CountCOUNTYPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
