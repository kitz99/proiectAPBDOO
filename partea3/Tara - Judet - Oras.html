...
<report name="Tara - Judet - Oras" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="TARA - JUDET - ORAS" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL COUNTRY.COUNTRY_ID, 
COUNTRY.COUNTRY, COUNTY.COUNTY_ID, COUNTY.COUNTRY_ID, 
COUNTY.COUNTY, CITY.CITY_ID, CITY.COUNTY_ID, CITY.CITY
FROM COUNTRY, COUNTY, CITY
WHERE ((COUNTY.COUNTRY_ID = COUNTRY.COUNTRY_ID)
 AND (CITY.COUNTY_ID = COUNTY.COUNTY_ID)) ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_COUNTRY_ID">
        <displayInfo x="0.68152" y="1.94995" width="2.63708" height="0.97949"
        />
        <dataItem name="COUNTRY_ID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Country Id">
          <dataDescriptor expression="COUNTRY.COUNTRY_ID"
           descriptiveExpression="COUNTRY_ID" order="1" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTY_ID1" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="County Id1">
          <dataDescriptor expression="CITY.COUNTY_ID"
           descriptiveExpression="COUNTY_ID" order="7" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="CountCOUNTY_IDPerCOUNTRY_ID" source="COUNTY_ID"
         function="count" precision="8" reset="G_COUNTRY_ID" compute="report"
         defaultWidth="100000" defaultHeight="10000" columnFlags="552"
         defaultLabel="Count:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
        </summary>
        <summary name="CountCITY_IDPerCOUNTRY_ID" source="CITY_ID"
         function="count" precision="8" reset="G_COUNTRY_ID" compute="report"
         defaultWidth="100000" defaultHeight="10000" columnFlags="552"
         defaultLabel="Count:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
      ...
      <group name="G_COUNTRY">
        <displayInfo x="1.26746" y="3.67944" width="1.46521" height="1.33936"
        />
        <dataItem name="COUNTRY" datatype="vchar2" columnOrder="12"
         width="510" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Country">
          <dataDescriptor expression="COUNTRY.COUNTRY"
           descriptiveExpression="COUNTRY" order="2" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTY" datatype="vchar2" columnOrder="15" width="510"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="County">
          <dataDescriptor expression="COUNTY.COUNTY"
           descriptiveExpression="COUNTY" order="5" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CITY" datatype="vchar2" columnOrder="18" width="510"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="City">
          <dataDescriptor expression="CITY.CITY" descriptiveExpression="CITY"
           order="8" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTY_ID" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="County Id">
          <dataDescriptor expression="COUNTY.COUNTY_ID"
           descriptiveExpression="COUNTY_ID" order="3" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTRY_ID1" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Country Id1">
          <dataDescriptor expression="COUNTY.COUNTRY_ID"
           descriptiveExpression="COUNTRY_ID" order="4" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CITY_ID" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="City Id">
          <dataDescriptor expression="CITY.CITY_ID"
           descriptiveExpression="CITY_ID" order="6" width="22" precision="6"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountCOUNTY_IDPerReport" source="COUNTY_ID"
     function="count" precision="8" reset="report" compute="report"
     defaultWidth="100000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Count:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
    </summary>
    <summary name="CountCITY_IDPerReport" source="CITY_ID" function="count"
  ...
  <section name="main">
    <body>
      <frame name="M_G_COUNTRY_ID_GRPFR">
        ...
        <repeatingFrame name="R_G_COUNTRY_ID" source="G_COUNTRY_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_COUNTRY_GRPFR">
            <geometryInfo x="5.00000" y="0.18750" width="1.87500"
             height="0.18750"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_COUNTRY" source="G_COUNTRY"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="5.00000" y="0.18750" width="1.87500"
               height="0.18750"/>
              ...
              <field name="F_COUNTRY" source="COUNTRY" minWidowLines="1"
               spacing="0" alignment="start">
                ...
                <geometryInfo x="5.00000" y="0.18750" width="0.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_COUNTY" source="COUNTY" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="9"/>
              ...
              <field name="F_CITY" source="CITY" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="9"/>
                <geometryInfo x="6.25000" y="0.18750" width="0.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
          </frame>
          <field name="F_COUNTRY_ID" source="COUNTRY_ID" minWidowLines="1"
           spacing="0" alignment="start">
          ...
          <field name="F_COUNTY_ID1" source="COUNTY_ID1" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="9" bold="yes" textColor="TextColor"/>
            <geometryInfo x="1.12500" y="0.18750" width="1.12500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <field name="F_CountCOUNTY_IDPerCOUNTRY_ID"
           source="CountCOUNTY_IDPerCOUNTRY_ID" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9" bold="yes" textColor="TextColor"/>
            <geometryInfo x="2.25000" y="0.18750" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <field name="F_CountCITY_IDPerCOUNTRY_ID"
           source="CountCITY_IDPerCOUNTRY_ID" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9" bold="yes" textColor="TextColor"/>
        ...
        <frame name="M_G_COUNTRY_ID_HDR">
          ...
          <text name="B_COUNTRY_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="0.00000" width="1.12500"
             height="0.18750"/>
          ...
          <text name="B_COUNTY_ID1" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.12500" y="0.00000" width="1.12500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="white"/>
          ...
          <text name="B_CountCOUNTY_IDPerCOUNTRY_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.25000" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="white"/>
          ...
          <text name="B_CountCITY_IDPerCOUNTRY_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.62500" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes" textColor="white"/>
          ...
          <text name="B_COUNTRY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.00000" y="0.00000" width="0.62500"
             height="0.18750"/>
          ...
          <text name="B_COUNTY" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_CITY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.25000" y="0.00000" width="0.62500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes"
      ...
      <frame name="M_Plain_FTR">
        ...
        />
        <visualSettings fillPattern="transparent" fillBackgroundColor="Totals"/>
        <field name="F_CountCOUNTY_IDPerReport"
         source="CountCOUNTY_IDPerReport" minWidowLines="1" spacing="0"
         alignment="start">
          <font face="helvetica" size="10" bold="yes" textColor="TextColor"/>
          <geometryInfo x="0.43750" y="0.37500" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_CountCOUNTY_IDPerReport" minWidowLines="1">
          <textSettings spacing="0"/>
        ...
        <field name="F_CountCITY_IDPerReport" source="CountCITY_IDPerReport"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10" bold="yes" textColor="TextColor"/>
          <geometryInfo x="2.37500" y="0.37500" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_CountCITY_IDPerReport" minWidowLines="1">
          <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.45789" y="0.25000" width="1.58411" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[Tara - Judet - Oras]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <reportPrivate defaultReportType="tabBrkLeft" versionFlags2="0"
   templateName="rwpeach" sectionTitle="Tara - Judet - Oras"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
