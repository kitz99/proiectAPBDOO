...
<report name="Utilizator - Limba" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL APP_USER.USER_ID, 
APP_USER.USERNAME, APP_USER.FIRST_NAME, APP_USER.LAST_NAME, LANGUAGE.LANGUAGE_ID, LANGUAGE.NAME, APP_USER.LANGUAGE_ID
FROM APP_USER, LANGUAGE
WHERE (APP_USER.LANGUAGE_ID = LANGUAGE.LANGUAGE_ID) ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_LANGUAGE_ID">
        <displayInfo x="0.57166" y="1.94995" width="2.85681" height="0.61963"
        />
        <dataItem name="LANGUAGE_ID" oracleDatatype="number" columnOrder="15"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Language Id">
          <dataDescriptor expression="LANGUAGE.LANGUAGE_ID"
           descriptiveExpression="LANGUAGE_ID" order="5" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="CountCountUSER_IDPerLANGUAGE_I" source="CountUSER_ID"
         function="count" precision="8" reset="G_LANGUAGE_ID" compute="report"
      ...
      <group name="G_FIRST_NAME">
        <displayInfo x="1.30408" y="3.31958" width="1.39197" height="0.61963"
        />
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="First Name">
          <dataDescriptor expression="APP_USER.FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="3" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="14"
         width="510" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Last Name">
          <dataDescriptor expression="APP_USER.LAST_NAME"
           descriptiveExpression="LAST_NAME" order="4" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      <group name="G_NAME">
        <displayInfo x="1.45007" y="4.68921" width="1.09998" height="0.43970"
        />
        <dataItem name="NAME" datatype="vchar2" columnOrder="16" width="510"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Name">
          <dataDescriptor expression="LANGUAGE.NAME"
           descriptiveExpression="NAME" order="6" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      <group name="G_USER_ID">
        <displayInfo x="1.23083" y="5.87891" width="1.53845" height="0.79956"
        />
        <dataItem name="USER_ID" oracleDatatype="number" columnOrder="11"
         ...
         defaultLabel="User Id">
          <dataDescriptor expression="APP_USER.USER_ID"
           descriptiveExpression="USER_ID" order="1" width="22" precision="6"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="USERNAME" datatype="vchar2" columnOrder="12"
         ...
         columnFlags="1" defaultLabel="Username">
          <dataDescriptor expression="APP_USER.USERNAME"
           descriptiveExpression="USERNAME" order="2" width="510"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LANGUAGE_ID1" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Language Id1">
          <dataDescriptor expression="APP_USER.LANGUAGE_ID"
           descriptiveExpression="LANGUAGE_ID" order="7" width="22"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <crossProduct name="G_CountUSER_ID">
      <displayInfo x="1.00415" y="3.01965" width="1.99182" height="2.40918"/>
      <dimension>
        <group name="G_FIRST_NAME"/>
      </dimension>
      <dimension>
      ...
      <summary name="CountUSER_ID" source="USER_ID" function="count"
       precision="8" reset="G_NAME" compute="report" defaultWidth="100000"
       defaultHeight="10000" columnFlags="552" defaultLabel="Countuser Id"
       productOrder="G_FIRST_NAME G_NAME">
        <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"
        />
      </summary>
      <summary name="CountCountUSER_IDPerFIRST_NAME" source="CountUSER_ID"
       function="count" precision="8" reset="G_FIRST_NAME" compute="report"
       defaultWidth="100000" defaultHeight="10000" columnFlags="552"
       defaultLabel="Count:" productOrder="G_FIRST_NAME">
        <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"
        />
      </summary>
      <summary name="CountCountUSER_IDPerNAME" source="CountUSER_ID"
       function="count" precision="8" reset="G_NAME" compute="report"
       defaultWidth="100000" defaultHeight="10000" columnFlags="552"
       defaultLabel="Count:" productOrder="G_NAME">
        <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"
        />
      </summary>
    </crossProduct>
    <summary name="CountCountUSER_IDPerReport" source="CountUSER_ID"
  ...
  <section name="main">
    <body>
      <frame name="M_G_LANGUAGE_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.00000" height="1.12500"
        />
        <generalLayout verticalElasticity="variable"
         horizontalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_LANGUAGE_ID" source="G_LANGUAGE_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.00000" width="6.00000"
           height="0.93750"/>
          <generalLayout verticalElasticity="variable"
           horizontalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
          ...
          <field name="F_LANGUAGE_ID" source="LANGUAGE_ID" minWidowLines="1"
           spacing="0" alignment="start">
            ...
            <geometryInfo x="0.87500" y="0.00000" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_CountUSER_ID_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="6.00000"
             height="0.75000"/>
            <generalLayout verticalElasticity="variable"
             horizontalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
            ...
            <repeatingFrame name="R_G_FIRST_NAME" source="G_FIRST_NAME"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.56250" width="6.00000"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
              ...
              <field name="F_CountCountUSER_IDPerFIRST_NA"
               source="CountCountUSER_IDPerFIRST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="4.50000" y="0.56250" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
                <visualSettings fillPattern="transparent"
            ...
            <repeatingFrame name="R_G_NAME" source="G_NAME"
             printDirection="across" minWidowRecords="1" columnMode="no">
              ...
              <text name="B_CountUSER_ID" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.00000" y="0.37500" width="1.50000"
                 height="0.18750"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"/>
                  <string>
              ...
              <field name="F_CountUSER_ID" source="CountUSER_ID"
              ...
              <field name="F_CountCountUSER_IDPerNAME"
               source="CountCountUSER_IDPerNAME" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="3.00000" y="0.75000" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
                <visualSettings fillPattern="transparent"
                 fillBackgroundColor="Totals"/>
            ...
            <field name="F_CountCountUSER_IDPerLANGUAGE"
             source="CountCountUSER_IDPerLANGUAGE_I" minWidowLines="1"
             spacing="0" alignment="start">
              <font face="helvetica" size="10" bold="yes"/>
              <geometryInfo x="4.50000" y="0.75000" width="1.50000"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
            </field>
        ...
        <frame name="M_G_LANGUAGE_ID_FTR">
          <geometryInfo x="0.00000" y="0.93750" width="6.00000"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_CountCountUSER_IDPerReport"
           source="CountCountUSER_IDPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.43750" y="0.93750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_CountCountUSER_IDPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
      ...
      <matrix name="X_G_CountUSER_ID" horizontalFrame="R_G_FIRST_NAME"
       verticalFrame="R_G_NAME" xProductGroup="G_CountUSER_ID">
        <geometryInfo x="3.00000" y="0.56250" width="1.50000" height="0.18750"
        />
      </matrix>
    </body>
    <margin>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="matrixBreak" versionFlags2="0"
   templateName="rwgreen" sectionTitle="User-Language"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
